...
# Optional overrides:
#   NPROC_PER_NODE=2 NUM_PARALLEL_ENVS=8 SCENE_POOL_SIZE=16 ACTION_STEP_XYZ=0.015 HOLD_STEPS=10 \
...
SCENE_POOL_SIZE="${SCENE_POOL_SIZE:-16}"
...
ACTION_STEP_XYZ="${ACTION_STEP_XYZ:-0.006}"
ACTION_STEP_YAW="${ACTION_STEP_YAW:-0.08}"
HOLD_STEPS="${HOLD_STEPS:-4}"
